...
public class AsyncConfig implements AsyncConfigurer {
    ...
    public Executor getAsyncExecutor() {
        ...
        executor.setCorePoolSize(5);                // Thread pool에서 기본적으로 유지되는 스레드의 개수
        executor.setMaxPoolSize(10);                // Thread pool에서 사용할 수 있는 최대 스레드의 개수
        executor.setQueueCapacity(100);             // 작업 큐가 최대로 가질 수 있는 작업 개수
